    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto max-w-3xl px-6 py-16 font-serif">
          <div className="space-y-6 text-xl leading-relaxed text-foreground/90">
            ...
            <p>
              In my final year, I'll be a Yale Journalism Initiative coordinating fellow, literary editor at the <em>Yale Literary Magazine</em>, and managing editor for the <em>Elm City Echo</em>. I study English literature and will write a poetry thesis.
            </p>
            <p>
