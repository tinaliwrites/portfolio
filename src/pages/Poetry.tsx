    ...
    <div className="min-h-screen bg-background flex flex-col p-6">
      ...
      <div className="flex-1 flex items-center justify-center pt-10 pb-20">
        <div className="flex flex-col items-start w-full max-w-lg mx-auto font-serif">
          <h1 className="text-3xl font-medium mb-8">some poetry</h1>
          <div className="space-y-6 text-xl leading-relaxed text-foreground/90">
            ...
            <p className="text-muted-foreground italic">
              more forthcoming... or <a href="mailto:tina.jh.li@yale.edu" className="underline decoration-primary/30 hover:decoration-primary transition-colors underline-offset-4">email me!</a> i'd love to chat poetry and exchange writing
            </p>
          </div>
        </div>
      </div>
