        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="container mx-auto max-w-3xl px-6 py-16 font-serif">
                <div className="space-y-10 text-lg leading-snug text-foreground/90">
                    <FadeInSection>
                        <p>
                            I was born in Chinatown in Brooklyn, New York. I’ve lived in Fuzhou, China; Huntersville, North Carolina; and Chesapeake, Virginia. But I mainly grew up in Norfolk, Virginia (the largest naval base in the world!) and I now spend my time in between New Haven, Norfolk, and the DMV area. I somehow always find an excuse, though, to fly to San Francisco a couple times a year. In my free time, I enjoy hiking, reading <a href="https://pudding.cool/" target="_blank" rel="noopener noreferrer" className="underline decoration-primary/30 hover:decoration-primary transition-colors underline-offset-4">funky</a> <a href="https://reallifemag.com/" target="_blank" rel="noopener noreferrer" className="underline decoration-primary/30 hover:decoration-primary transition-colors underline-offset-4">online</a> <a href="https://www.thedriftmag.com/" target="_blank" rel="noopener noreferrer" className="underline decoration-primary/30 hover:decoration-primary transition-colors underline-offset-4">magazines</a>, writing poetry, and seeing plays.
                        </p>
                    </FadeInSection>
