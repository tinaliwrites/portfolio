        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="container mx-auto max-w-3xl px-6 py-16 font-serif">
                <div className="space-y-10 text-lg leading-snug text-foreground/90">
                    <FadeInSection>
                        <p>
                            I was born in Brooklyn, New York and I spent my early childhood in Fuzhou, China. But I mainly grew up in Norfolk, Virginia (the largest naval base in the world!) and I now spend my time in between New Haven, Norfolk, and the DMV area. I somehow always find an excuse, though, to fly to San Francisco a couple times a year. I enjoy hiking, seeing plays, <a href="https://boxd.it/9Yq4Z" target="_blank" rel="noopener noreferrer" className="underline decoration-primary/30 hover:decoration-primary transition-colors underline-offset-4">watching movies</a>, and <Link to="/poetry" className="underline decoration-primary/30 hover:decoration-primary transition-colors underline-offset-4">writing poetry</Link>.
                        </p>
                    </FadeInSection>
                    ...
                    <FadeInSection>
                        <p>
                            My favorite films are <em>Phantom Thread</em> (Paul Thomas Anderson, 2017), <em>King Lear</em> (Jean-Luc Godard, 1988), and <em>Chungking Express</em> (Wong Kar-Wai, 1994). My favorite Jane Austen adaptations are <em>Persuasion</em> (1995) and BBC’s <em>Pride and Prejudice</em> miniseries (1995). Lots of great things were happening in 1995! I enjoy writing with Chopin’s Preludes, Legend of Zelda soundtracks, or instrumental jazz in the background. I love The Cure and The Smiths. I procrastinate by perusing fun multimedia magazines such as <a href="https://pudding.cool/" target="_blank" rel="noopener noreferrer" className="underline decoration-primary/30 hover:decoration-primary transition-colors underline-offset-4"><em>The Pudding</em></a> and <a href="https://thehtml.review/05/" target="_blank" rel="noopener noreferrer" className="underline decoration-primary/30 hover:decoration-primary transition-colors underline-offset-4"><em>The HTML Review</em></a>.
                        </p>
                    </FadeInSection>
