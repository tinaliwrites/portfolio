        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="container mx-auto max-w-3xl px-6 py-16 font-serif">
                <div className="space-y-10 text-lg leading-snug text-foreground/90">
                    ...
                    <FadeInSection>
                        <p>
                            My favorite films are <em>Phantom Thread</em> (Paul Thomas Anderson, 2017), <em>Peppermint Soda</em> (Diane Kurys, 1977), <em>King Lear</em> (Jean-Luc Godard, 1988), and <em>Chungking Express</em> (Wong Kar-Wai, 1994). My favorite Jane Austen adaptations are <em>Persuasion</em> (1995) and BBC’s <em>Pride and Prejudice</em> miniseries (1995). Lots of great things were happening in 1995! I enjoy writing with Chopin’s Preludes, Legend of Zelda soundtracks, or jazz in the background. I love The Cure and The Smiths.
                        </p>
                    </FadeInSection>
